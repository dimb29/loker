...
class NotifStar extends Component
{
    ...
    public function mount(){
        ...
        $notifs = Notif::with('notif_user')->where(['to' => $usid, 'save' => 1])->orderBy('created_at', 'DESC')->get();
        $this->notifs = $notifs;
    }
    public function render()
    {
        ...
        return view('livewire.notif.employer.notif-star');
    }
    ...
    public function clickClose(){
        $this->isOpen = false;
        return redirect()->route('employer.notif.star');
    }
}
