<div class="lg:flex">
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        ...
        <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            xl:text-bold">Lengkapi data diri anda!</h2>
            <div class="mt-12">
                ...
                <div>
                    <div>
                        ...
                        <x-jet-input id="first_name" wire:model="first_name" type="text" name="first_name" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Liam"/>
                    ...
                    <div class="mt-8">
                        ...
                        <x-jet-input id="last_name" wire:model="last_name" type="text" name="last_name" :value="old('last_name')" required autocomplete="last_name" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Hemsworth"/>
                    ...
                    <div class="mt-8">
                        ...
                        <x-jet-input id="email" wire:model="email" type="email" name="email" readonly="readonly" :value="old('email')" required class="w-full readonly text-gray-300 text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="liam.h@gmail.com"/>
                    ...
                    <div class="mt-8">
                        ...
                        <x-jet-input id="kode_referal" wire:model="kode_referal" type="text" name="kode_referal" autocomplete="kode_referal" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="5df1#Y"/>
                        @error('kode_referal') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div>
                    <div class="my-10">
                        <x-jet-button type="button" wire:click="store" class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
